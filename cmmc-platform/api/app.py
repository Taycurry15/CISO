...
from hitl_review_api import router as hitl_review_router
...
app.dependency_overrides[hitl_review_api.get_db_pool] = get_db_pool
...
app.include_router(hitl_review_router, prefix="/api/v1", tags=["hitl-reviews"])
