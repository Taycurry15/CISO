...
Supports both sync and async database migrations for PostgreSQL.
"""
...
def get_url():
    ...
    if url:
        # Convert async URL to sync for SQLAlchemy if needed
...
def run_migrations_online() -> None:
    ...
    # Detect if we should use async (default for this project)
    use_async = os.getenv("ALEMBIC_USE_SYNC", "false").lower() != "true"
